...
static force_inline ORMDBDataType ORMDBGetDataType(const char *typeEncoding) {
    ...
    switch (*type) {
        case 'B':
            return ORMDBDataTypeBool;
        case 'c':
            return ORMDBDataTypeInt;
        case 'C':
            return ORMDBDataTypeInt;
        case 's':
            return ORMDBDataTypeInt;
        ...
        case 'Q':
            return ORMDBDataTypeInt;
        case 'f':
            return ORMDBDataTypeFloat;
        case 'd':
            return ORMDBDataTypeDouble;
        case 'D':
            return ORMDBDataTypeDouble;
        default:
...
- (instancetype)initWithClass:(Class)cls {
    ...
    if (self) {
        ...
        if (foreignSignature) {
            ignoreColumn = ((NSArray * (*)(id, SEL))(
            void *) objc_msgSend)((id) cls, NSSelectorFromString(@"sqlIgnoreColumn"));
        }
        ...
        if (foreignKeyOperationSignature) {
            foreignKeyOperation = ((NSDictionary * (*)(id, SEL))(
            void *) objc_msgSend)((id) cls, NSSelectorFromString(@"foreignKeyNotCreateTable"));
        }
...
+ (void)updateTable:(id)res andPropertyName:(Class)cls andParentEntity:(id)entity {
    ...
    if (foreignSignature) {
        ...
        if ([cls respondsToSelector:NSSelectorFromString(@"primarilyKey")]) {
            resPrimaryKey = ((NSString * (*)(id, SEL))(
            void *) objc_msgSend)((id) [cls class], NSSelectorFromString(@"primarilyKey"));
